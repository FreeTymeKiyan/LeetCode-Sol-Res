    ...
    public Object[][] getExamples() {
        return new Object[][]{
                ...
                new Object[]{"fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami", Arrays.asList("kfomka", "hecagbngambii", "anobmnikj", "c", "nnkmfelneemfgcl", "ah", "bgomgohl", "lcbjbg", "ebjfoiddndih",
                        ...
                        "ifccifn", "naedmco", "iohchafbega", "kjejfhbco", "anlhhhhg"), true},
        };
    }

    @Test(dataProvider = "examples")
    public void testWordBreak(String s, List<String> words, boolean output) {
        WordBreak w = new WordBreak();
        Assert.assertEquals(w.wordBreak(s, words), output);
    }

    @Test(dataProvider = "examples")
    public void testWordBreak2(String s, List<String> words, boolean output) {
        WordBreak w = new WordBreak();
        Assert.assertEquals(w.wordBreak2(s, words), output);
    }
}